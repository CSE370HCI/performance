...
function setyear(year){
   if (year == '2017'){
     ...
     document.getElementById('2017tab').classList.add("selected");
     document.getElementById('2018tab').classList.remove("selected");
   }else{
     document.getElementById('2017').style.display = 'none';
     document.getElementById('2018').style.display = 'block';
     document.getElementById('2018tab').classList.add("selected");
     document.getElementById('2017tab').classList.remove("selected");
   }
}
